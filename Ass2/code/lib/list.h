...
T Next();
	...
	int num;		// number of threads in the ready list

	 ListElement<T> *first;  	// Head of the list, NULL if list is empty[MayDay]
    ListElement<T> *last;	// Last element of list[MayDay]
  protected:
